...
namespace projecthomestrategies_api.Migrations
{
    ...
    [Migration("20220605074658_BasicRecipeMigrtaion")]
    partial class BasicRecipeMigrtaion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeStrategiesApi.Models.BillImage", b =>
                {
                    b.Property<int>("BillImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("BillImageId");

                    b.HasIndex("BillId");

                    b.ToTable("BillImages");
                });
            ...
            modelBuilder.Entity("HomeStrategiesApi.Models.PlannedMeal", b =>
                {
                    b.Property<int>("PlannedMealId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("BasicRecipeName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HomeStrategiesApi.Models.BillImage", b =>
                {
                    b.HasOne("HomeStrategiesApi.Models.Bill", "Bill")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("HomeStrategiesApi.Models.PlannedMeal", b =>
                {
                    b.HasOne("HomeStrategiesApi.Models.User", "Creator")
                        .WithMany()
